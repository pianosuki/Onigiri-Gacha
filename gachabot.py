    ...
    while not (exit_flag):
        ...
        match str(reaction.emoji):
            case "📜":
                ...
                e.set_thumbnail(url = Resource["Kinka_Mei-3"][0])
                e.add_field(name = f"Tier 1: {Prizes['tier_1']['symbol']} | Tickets required: 🎟️ x {Prizes['tier_1']['tickets_required']}", value = formatPrizeList("tier_1"), inline = True)
                e.add_field(name = f"Tier 2: {Prizes['tier_2']['symbol']} | Tickets required: 🎟️ x {Prizes['tier_2']['tickets_required']}", value = formatPrizeList("tier_2"), inline = True)
                e.add_field(name = "\u200b", value = "\u200b", inline = True)
                e.add_field(name = f"Tier 3: {Prizes['tier_3']['symbol']} | Tickets required: 🎟️ x {Prizes['tier_3']['tickets_required']}", value = formatPrizeList("tier_3"), inline = True)
                e.add_field(name = f"Tier 4: {Prizes['tier_4']['symbol']} | Tickets required: 🎟️ x {Prizes['tier_4']['tickets_required']}", value = formatPrizeList("tier_4"), inline = True)
                e.add_field(name = "\u200b", value = "\u200b", inline = True)
                e.add_field(name = "Reaction Menu:", value = menu_top, inline = False)
